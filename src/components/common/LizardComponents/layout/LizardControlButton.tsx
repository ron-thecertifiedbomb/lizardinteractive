...
export function LizardControlButton() {
    ...
    const { hideControlPanelButton, showLeftPanel, showRightPanel, setHideControlPanelButton, setShowRightPanel, setShowLeftPanel, } = useControlPanelStore()
    ...
    return (
        ...
        >
            <LizardDiv
                onClick={() => {
                    setHideControlPanelButton(!hideControlPanelButton); setShowRightPanel(!showRightPanel); setShowLeftPanel(!showLeftPanel); setShowPanel(!showPanel);
                }}
